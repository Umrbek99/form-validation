...
import {
    required,
    min,
    max, alpha_spaces as alphaSpaces, email, min_value as minVal, max_value as maxVal, confirmed, not_one_of as excluded
...
export default {
    install(app) {
        ...
        defineRule('not_of_one', excluded)
        ...
        configure({
            generateMessage: (context) => {
                const messages = {
                    ...
                    alpha_spaces: `The field ${context.field} may contain only characters and spaces.`,
